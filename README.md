...
1. Реализовать необходимые модели привычек.
2. Реализовать точки входа для работы с фронтендом.
3. Создайте приложение для работы с Telegram и рассылками напоминаний.

### Модели 

Привычка описывается как конкретное действие, которое можно уложить в одно предложение:
...
Исходя из этого получаем модель — Привычка.
...
- Все необходимые точки входа реализовали.
